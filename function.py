...
Pathlist = ['/plugins/function.php','/file/function.php','/as/function','/mah/function.php','/admin/function.php','/doc/function.php','/about/function.php','/index/function.php']
	...
	def checker(self, site):
		try:
			...
			for Path in Pathlist:
				...
				if('-rw-r--r--' in check):
					print('[x] {} --> {}[Function Shell]').format(url, fg)
					open('Function.txt','a').write(url + Path + "\n")
					break
				else:
